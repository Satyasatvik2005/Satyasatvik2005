...
- 💼 **Industry-proven** — interned at **Unified Mentor** and contributed part-time at **Accenture**, delivering live projects with measurable impact
- ⚡ **Performance-obsessed** — improved web app load performance by **20%** at Unified Mentor through code optimization and debugging
- 🌱 **Relentless learner** — 5 Coursera certifications, always building something new, always pushing the stack further
- 📍 Based in **Bengaluru** · Fluent in English, Hindi, Kannada & Telugu · Open to **Remote / Hybrid / Relocation**
...
Built and deployed responsive web applications; **improved app performance by 20%** through targeted debugging, code optimization, and front-end refactoring.
...
Led development of an AI-powered facial recognition attendance system; **reduced manual attendance errors by 90%** through full end-to-end automation.
...
Delivered multiple live client projects on schedule; **received appreciation certifications** for performance optimization contributions and code quality.
...
A production-grade ML security tool that classifies emails as phishing, spam, or legitimate with **multi-tier risk scoring and real-time analysis** — deployed and live. Built with TF-IDF vectorization and Naive Bayes to flag malicious URLs, suspicious keywords, and sender patterns through a glassmorphism dashboard backed by SQLite audit history.
...
A full-stack personal finance platform with **CRUD expense management, smart overspend alerts, and year-over-year financial intelligence** — live on Render. Delivers category-wise Chart.js visualizations and budget analytics through a modern responsive UI backed by Flask and SQLite.
...
A production-hardened weather platform covering **all 195 countries** with real-time data, 5-day forecasts, and one-click geolocation — built for scale. Features server-side caching, API rate limiting, and security hardening (Helmet + CORS) wrapped in a fully responsive glassmorphism UI with AOS scroll animations.
...
### 🏫 AI Campus Radar
A web-based issue intelligence platform enabling students to report campus problems — hostel quality, water, ragging, cleanliness — with a **centralized admin dashboard for real-time resolution tracking**. Applied data analysis to surface recurring issues and measurably reduce average administrative response time.
...
An end-to-end ML analytics project performing **exploratory data analysis on a large Spotify dataset** to predict track popularity from audio features. Trained and evaluated regression models on tempo, energy, danceability, and valence — surfacing actionable music trend insights through Seaborn/Matplotlib visualizations.
...
A distributed data engineering pipeline built on the **full Hadoop ecosystem for ingesting and processing large-scale structured datasets**. Architected HDFS storage, built Hive tables, and executed complex HiveQL queries for filtering, aggregation, and analytical reporting at scale.
...
### 🚗 Car Dodge — Browser Arcade Game
A polished browser-based arcade game featuring **smooth infinite scrolling, pixel-accurate collision detection, real-time score tracking, and LocalStorage high-score persistence** — all built from scratch without any game engine. Demonstrates deep JavaScript fundamentals, Canvas API mastery, and game loop architecture.
...
### 👁️ AI-Based Attendance System *(Internship)*
The flagship internship project — a **production AI system using OpenCV + dlib facial recognition** to fully automate classroom attendance, eliminating manual roll calls. Integrated secure biometric authentication and designed comprehensive UML architecture (use case, sequence, activity); **reduced attendance errors by 90%**.
...
**🧠 LLM Integration**
Exploring LangChain and RAG pipelines to build context-aware AI applications on top of open-source LLMs

</td>
<td width="33%" align="center">

**☁️ Cloud & DevOps**
Going deeper into AWS (EC2, S3, Lambda) and containerisation with Docker to ship more production-ready systems

</td>
<td width="33%" align="center">

**📱 React & Next.js**
Levelling up front-end skills to pair with existing Flask/Node.js backends — building toward full MERN/Next stack fluency
...
*"Code is the closest thing we have to a superpower — I'm here to use it."*
